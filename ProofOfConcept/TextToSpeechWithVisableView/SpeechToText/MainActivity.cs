...
{
    [Activity(Label = "PoC_NonContinuous", MainLauncher = true, Icon = "@drawable/icon")]
    public class MainActivity : Activity
    {
        ...
        protected override void OnCreate(Bundle bundle)
        {
            ...
            resultBox = FindViewById<TextView>(Resource.Id.resulthit);
            ...
            if (requestCode == VOICE)
            {
                if (resultVal == Result.Ok)
                {
                    ...
                    if (matches.Count != 0)
                    {
                        ...
                        string[] result_Hits = { "TPS Report", "Meeting Minutes", "ACA", "Synergy", "XML" };
                        foreach (string resultHit in result_Hits)
                        {
                            if (matches[0].ToLower().Contains(resultHit.ToLower()))
                            {
                                resultBox.Text = resultBox.Text + resultHit + "\r\n";
                            };
                        }
