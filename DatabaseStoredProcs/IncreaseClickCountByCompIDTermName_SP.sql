...
/****** Object:  StoredProcedure [dbo].[IncreaseClickCountByCompIDTermName]    Script Date: 10/22/2017 12:34:50 PM ******/
SET ANSI_NULLS ON
GO
...
-- =============================================
CREATE PROCEDURE [dbo].[IncreaseClickCountByCompIDTermName]
(
...
BEGIN
	...
	begin
		...
		begin
			Update TI
			SET TI.ClickHitCount = (TI.ClickHitCount + 1)
